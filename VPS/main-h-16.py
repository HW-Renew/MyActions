...
try:
    USER_ID_H_16 = os.environ['USER_ID_H_16']
except:
    # 本地调试用
    USER_ID_H_16 = ''

try:
    PASS_WD_H_16 = os.environ['PASS_WD_H_16']
except:
    # 本地调试用
    PASS_WD_H_16 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_H_16 == '':
        print('*** USER_ID_H_16 is empty ***')
        kill_browser()
    else:
        write(USER_ID_H_16, into=S('@username'))
    print('- fill password')
    if PASS_WD_H_16 == '':
        print('*** PASS_WD_H_16 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_H_16, into=S('@password'))
