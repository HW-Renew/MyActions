...
try:
    USER_ID_H_18 = os.environ['USER_ID_H_18']
except:
    # 本地调试用
    USER_ID_H_18 = ''

try:
    PASS_WD_H_18 = os.environ['PASS_WD_H_18']
except:
    # 本地调试用
    PASS_WD_H_18 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_H_18 == '':
        print('*** USER_ID_H_18 is empty ***')
        kill_browser()
    else:
        write(USER_ID_H_18, into=S('@username'))
    print('- fill password')
    if PASS_WD_H_18 == '':
        print('*** PASS_WD_H_18 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_H_18, into=S('@password'))
