...
try:
    USER_ID_H_17 = os.environ['USER_ID_H_17']
except:
    # 本地调试用
    USER_ID_H_17 = ''

try:
    PASS_WD_H_17 = os.environ['PASS_WD_H_17']
except:
    # 本地调试用
    PASS_WD_H_17 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_H_17 == '':
        print('*** USER_ID_H_17 is empty ***')
        kill_browser()
    else:
        write(USER_ID_H_17, into=S('@username'))
    print('- fill password')
    if PASS_WD_H_17 == '':
        print('*** PASS_WD_H_17 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_H_17, into=S('@password'))
