...
try:
    USER_ID_H_11 = os.environ['USER_ID_H_11']
except:
    # 本地调试用
    USER_ID_H_11 = ''

try:
    PASS_WD_H_11 = os.environ['PASS_WD_H_11']
except:
    # 本地调试用
    PASS_WD_H_11 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_H_11 == '':
        print('*** USER_ID_H_11 is empty ***')
        kill_browser()
    else:
        write(USER_ID_H_11, into=S('@username'))
    print('- fill password')
    if PASS_WD_H_11 == '':
        print('*** PASS_WD_H_11 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_H_11, into=S('@password'))
