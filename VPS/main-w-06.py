...
try:
    USER_ID_W_06 = os.environ['USER_ID_W_06']
except:
    # 本地调试用
    USER_ID_W_06 = ''
try:
    PASS_WD_W_06 = os.environ['PASS_WD_W_06']
except:
    # 本地调试用
    PASS_WD_W_06 = ''
try:
...
def login():
    ...
    print('- fill user id')
    if USER_ID_W_06 == '':
        print('*** USER_ID_W_06 is empty ***')
        kill_browser()
    else:
        write(USER_ID_W_06, into=S('@username'))
    print('- fill password')
    if PASS_WD_W_06 == '':
        print('*** PASS_WD_W_06 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_W_06, into=S('@password'))
