...
try:
    USER_ID_W_01 = os.environ['USER_ID_W_01']
except:
    # 本地调试用
    USER_ID_W_01 = ''

try:
    PASS_WD_W_01 = os.environ['PASS_WD_W_01']
except:
    # 本地调试用
    PASS_WD_W_01 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_W_01 == '':
        print('*** USER_ID_W_01 is empty ***')
        kill_browser()
    else:
        write(USER_ID_W_01, into=S('@username'))
    print('- fill password')
    if PASS_WD_W_01 == '':
        print('*** PASS_WD_W_01 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_W_01, into=S('@password'))
