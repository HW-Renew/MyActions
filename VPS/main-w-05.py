...
try:
    USER_ID_W_05 = os.environ['USER_ID_W_05']
except:
    # 本地调试用
    USER_ID_W_05 = ''

try:
    PASS_WD_W_05 = os.environ['PASS_WD_W_05']
except:
    # 本地调试用
    PASS_WD_W_05 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_W_05 == '':
        print('*** USER_ID_W_05 is empty ***')
        kill_browser()
    else:
        write(USER_ID_W_05, into=S('@username'))
    print('- fill password')
    if PASS_WD_W_05 == '':
        print('*** PASS_WD_W_05 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_W_05, into=S('@password'))
