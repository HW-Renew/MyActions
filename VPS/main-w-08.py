...
try:
    USER_ID_W_08 = os.environ['USER_ID_W_08']
except:
    # 本地调试用
    USER_ID_W_08 = ''
try:
    PASS_WD_W_08 = os.environ['PASS_WD_W_08']
except:
    # 本地调试用
    PASS_WD_W_08 = ''
try:
...
def login():
    ...
    print('- fill user id')
    if USER_ID_W_08 == '':
        print('*** USER_ID_W_08 is empty ***')
        kill_browser()
    else:
        write(USER_ID_W_08, into=S('@username'))
    print('- fill password')
    if PASS_WD_W_08 == '':
        print('*** PASS_WD_W_08 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_W_08, into=S('@password'))
