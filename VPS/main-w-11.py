...
try:
    USER_ID_W_11 = os.environ['USER_ID_W_11']
except:
    # 本地调试用
    USER_ID_W_11 = ''

try:
    PASS_WD_W_11 = os.environ['PASS_WD_W_11']
except:
    # 本地调试用
    PASS_WD_W_11 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_W_11 == '':
        print('*** USER_ID_W_11 is empty ***')
        kill_browser()
    else:
        write(USER_ID_W_11, into=S('@username'))
    print('- fill password')
    if PASS_WD_W_11 == '':
        print('*** PASS_WD_W_11 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_W_11, into=S('@password'))
