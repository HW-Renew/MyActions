...
try:
    USER_ID_H_8 = os.environ['USER_ID_H_8']
except:
    # 本地调试用
    USER_ID_H_8 = ''

try:
    PASS_WD_H_8 = os.environ['PASS_WD_H_8']
except:
    # 本地调试用
    PASS_WD_H_8 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_H_8 == '':
        print('*** USER_ID_H_8 is empty ***')
        kill_browser()
    else:
        write(USER_ID_H_8, into=S('@username'))
    print('- fill password')
    if PASS_WD_H_8 == '':
        print('*** PASS_WD_H_8 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_H_8, into=S('@password'))
